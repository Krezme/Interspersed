	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 color28 = IsGammaSpace() ? float4(0.5224056,1,0.4198113,1) : float4(0.2353686,1,0.1471786,1);
				
				float time26 = 44.0;
				float2 coords26 = packedInput.ase_texcoord5.xy * 3.0;
				float2 id26 = 0;
				float2 uv26 = 0;
				float fade26 = 0.5;
				float voroi26 = 0;
				float rest26 = 0;
				for( int it26 = 0; it26 <3; it26++ ){
				...
				float dotResult4 = dot( V , -_DirectionalLightDatas[0].forward );
				...
				surfaceDescription.Emission = ( color28 * ( pow( voroi26 , 2.0 ) * 0.033 ) ).rgb;
				surfaceDescription.Smoothness = 1.0;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = (0.15 + (saturate( dotResult4 ) - 0.0) * (0.85 - 0.15) / (1.0 - 0.0));
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float time26 = 44.0;
				float2 coords26 = packedInput.ase_texcoord.xy * 3.0;
				float2 id26 = 0;
				float2 uv26 = 0;
				float fade26 = 0.5;
				float voroi26 = 0;
				...
				float dotResult4 = dot( ase_worldViewDir , -_DirectionalLightDatas[0].forward );
		...
		Pass
		{
				...
				)
			{
				...
				float time26 = 44.0;
				float2 coords26 = packedInput.ase_texcoord7.xy * 3.0;
				float2 id26 = 0;
				float2 uv26 = 0;
				float fade26 = 0.5;
				float voroi26 = 0;
...
/*ASEBEGIN
Version=18813
0;0;2560;1379;2357.02;898.5478;1.3;True;True
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;1;-1753.019,242.6788;Inherit;False;False;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.VoronoiNode;26;-923.0162,-311.244;Inherit;False;0;0;1;0;3;True;3;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;44;False;2;FLOAT;3;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;5;-1724.031,-116.4057;Inherit;False;World;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.DotProductOpNode;4;-1120.823,83.95699;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;27;-719.7154,-14.644;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;30;-447.2159,-39.944;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.033;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;28;-481.0162,-345.244;Inherit;False;Constant;_Color0;Color 0;0;0;Create;True;0;0;0;False;0;False;0.5224056,1,0.4198113,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;6;-918.7029,133.0962;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NegateNode;2;-1343.657,274.9584;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;29;-305.8159,-18.44392;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.TFHCRemapNode;25;-466.9994,299.601;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0.15;False;4;FLOAT;0.85;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;31;-384.707,171.3898;Inherit;False;Constant;_Float0;Float 0;0;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;7;0,0;Float;False;True;-1;2;Rendering.HighDefinition.LightingShaderGraphGUI;0;14;SlimeShader2;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;35;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;-27;False;False;False;False;False;False;False;False;False;True;True;0;True;-14;255;False;-1;255;True;-13;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;True;0;True;-15;False;True;1;LightMode=GBuffer;False;0;;0;0;Standard;42;Surface Type;1;  Rendering Pass;1;  Refraction Model;0;    Blending Mode;0;    Blend Preserves Specular;1;  Receive Fog;1;  Back Then Front Rendering;1;  Transparent Depth Prepass;1;  Transparent Depth Postpass;1;  Transparent Writes Motion Vector;1;  Distortion;0;    Distortion Mode;0;    Distortion Depth Test;1;  ZWrite;0;  Z Test;4;Double-Sided;0;Alpha Clipping;0;  Use Shadow Threshold;0;Material Type,InvertActionOnDeselection;0;  Energy Conserving Specular;1;  Transmission;1;Receive Decals;1;Receives SSR;1;  Receive SSR Transparent;0;Motion Vectors;1;  Add Precomputed Velocity;0;Specular AA;0;Specular Occlusion Mode;1;Override Baked GI;0;Depth Offset;0;DOTS Instancing;0;LOD CrossFade;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position;1;0;11;True;True;True;True;True;True;False;True;True;True;True;False;;False;0
...
WireConnection;7;6;29;0
WireConnection;7;7;31;0
WireConnection;7;9;25;0
ASEEND*/
//CHKSM=01C712BF48467A7990B3D3A03E42A7DBE6B9D335